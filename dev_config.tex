...
The Addr field store the 4K-byte aligned physical address of the level-1 device table.
...
The Addr field store the 4K-byte aligned address of the translation descriptor.
